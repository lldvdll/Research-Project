...
`current_state.md` is referenced by `CLAUDE.md` but **does not exist**; `progress.md` and this
file cover what it was meant to. `handover.md` is the 2026-09-10 build-pass record — history
now, superseded by `report_progress.md` for anything current.
