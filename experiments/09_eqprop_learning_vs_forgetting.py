"""09_eqprop_learning_vs_forgetting
Q: When task 2 arrives, how fast does EqProp learn it and how fast does it lose task 1?
   Controls: backprop (forgets), replay (retains). Under test: eqprop.
...
ax[1].set_title("eqprop raw outputs (move before accuracy flips)"); ax[1].legend(fontsize=8)
