...
Chance is 10% here, not 20%, and the joint ceiling is 93.6%. Accuracies are NOT comparable with
the Domain-IL scripts; only the ordering of the rules within a scenario is.
